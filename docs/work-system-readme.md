...
- **[work-system-implementation-plan.md](work-system-implementation-plan.md)**: Implementation history
- **[sub-agents-guide.md](sub-agents-guide.md)**: Agent development guide
...
- **Documentation**: See [work-system-guide.md](work-system-guide.md)
