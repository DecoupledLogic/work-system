...
If you want, next step we can pull out the Agent contract for one stage, for example TriageAgent, and define:

-   Exact input JSON.
-   Exact output JSON.
-   Required actions it must log.

So you can wire it straight into your orchestrator.
